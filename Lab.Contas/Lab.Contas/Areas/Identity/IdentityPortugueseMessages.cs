...
namespace Lab.Contas.Areas.Identity
{
    public class IdentityPortugueseMessages : IdentityErrorDescriber
    {
        ...
        public override IdentityError PasswordRequiresLower() { return new IdentityError { Code = nameof(PasswordRequiresLower), Description = "A senha deve conter ao menos um caractere minúsculo ('a'-'z')." }; }
        public override IdentityError PasswordRequiresUpper() { return new IdentityError { Code = nameof(PasswordRequiresUpper), Description = "A senha deve conter ao menos um caractere maiúsculo ('A'-'Z')." }; }
    }
}
